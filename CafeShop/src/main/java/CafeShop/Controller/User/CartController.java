...
import CafeShop.Service.User.CartServiceImpl;
...
public class CartController extends BaseController{
	...
	public String EditCart(HttpServletRequest req ,HttpSession session, @PathVariable long id, @PathVariable int quanty ) {
		HashMap<Long , CartDto> cart = (HashMap<Long, CartDto>)session.getAttribute("Cart");
		if(cart == null) {
			cart = new HashMap<Long, CartDto>();
		}
